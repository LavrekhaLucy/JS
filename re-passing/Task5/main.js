...
let SquareWithHigh = (h,r) => 2 * Math.PI * r * (r+h);
console.log(SquareWithHigh(8,5));
...
createListFromArray(['Create','List','From','Array'])
...
let numbersArray1 = [1,2,3,4,5,6,8,-6];
let min = lessNumber1(numbersArray1);
console.log(min);
...
let numbers2 = swap1 ([11,22,33,44,],0,1);
